...
-- ============================================================
-- Migration 065: Micro-Labs Schema + Seed (with domain alignment)
-- ============================================================
...
-- ============================================================
-- Using ON CONFLICT DO NOTHING so this migration is safe to re-run
-- if 042 is ever applied separately.
...
INSERT INTO micro_labs (
    ...
    lab_directory, track_id, max_score, passing_score, num_devices
) VALUES (
    'junos-cli-basics',
    'JunOS CLI Basics',
