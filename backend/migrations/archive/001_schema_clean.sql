...
CREATE TABLE IF NOT EXISTS exams (
    ...
    level VARCHAR(20) NOT NULL CHECK (level IN ('JNCIA', 'JNCIS', 'JNCIP', 'JNCIE', 'CCNA', 'CCNP', 'CCIE')),
...
CREATE INDEX IF NOT EXISTS idx_exams_track_id ON exams(track_id);
CREATE INDEX IF NOT EXISTS idx_questions_exam_id ON questions(exam_id);
CREATE INDEX IF NOT EXISTS idx_questions_track_id ON questions(track_id);
